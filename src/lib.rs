...
#[derive(Debug)]
pub struct ActiveRecordProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ActiveRecordProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ActiveRecord processing");
    
    let mut processor = ActiveRecordProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ActiveRecordProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ActiveRecordProcessor::new(false);
